                          ...
                          onTap: () {
                            Get.to(() => PaidSongsAddVoiceNoteScreen(
                                  imagePath: controller.selectedTab.value == 0
                                      ? controller
                                          .motivationalList[index].imagePath
                                      : controller.selectedTab.value == 1
                                          ? controller
                                              .griefList[index].imagePath
                                          : controller.selectedTab.value == 2
                                              ? controller.encourageList[index]
                                                  .imagePath
                                              : controller
                                                  .loveList[index].imagePath,
                                  title: controller.selectedTab.value == 0
                                      ? controller
                                          .motivationalList[index].songTitle
                                      : controller.selectedTab.value == 1
                                          ? controller
                                              .griefList[index].songTitle
                                          : controller.selectedTab.value == 2
                                              ? controller.encourageList[index]
                                                  .songTitle
                                              : controller
                                                  .loveList[index].songTitle,
                                ));
                          },
