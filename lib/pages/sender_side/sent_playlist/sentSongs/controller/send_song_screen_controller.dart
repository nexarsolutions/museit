...
import '../../../../../globalModels/sent_songs_model.dart';

class SentSongsController extends GetxController {
  final isLoading = false.obs;
  final isPaginating = false.obs;
  final errorMessage = ''.obs;
  final receivedSongs = <SentSongModel>[].obs;
    ...
    try {
      await ApiService().handleGetResponse(
        apiMethod: () => SongService()
            .sentSongsApi(limit: limit, offset: currentPage.value),
        onSuccess: (success) {
          final data = SentSongResponseModel.fromJson(success);
