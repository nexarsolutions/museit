...
import 'controller/recipient_view_community_controller.dart';

class RecipientViewCommunityScreen extends StatelessWidget {
  ...
  final controller = Get.put(RecipientViewCommunityController());
  @override
