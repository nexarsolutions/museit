...
import 'controller/recipient_edit_profile_controller.dart';

class RecipientEditProfileScreen extends StatelessWidget {
  RecipientEditProfileScreen({super.key});
  final controller = Get.put(RecipientEditProfileController());
