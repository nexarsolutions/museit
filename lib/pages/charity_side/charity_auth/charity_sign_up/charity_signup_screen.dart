...
import '../charity_verify_email/charity_verify_email_screen.dart';
import 'controller/charity_signup_controller.dart';

class CharitySignupScreen extends StatelessWidget {
  CharitySignupScreen({super.key,});

  final controller = Get.put(CharitySignupController());
                      ...
                      child: CustomButton(
                        onPressed: () {
                          if (controller.formKey.currentState!.validate()) {
                            Get.to(() => CharityVerifyEmailScreen());
                          }
                        },
                        text: 'Sign up',
                      ),
