...
import 'controller/charity_verify_email_controller.dart';


class CharityVerifyEmailScreen extends StatelessWidget {
  CharityVerifyEmailScreen({super.key});

  final controller = Get.put(CharityVerifyEmailController());
