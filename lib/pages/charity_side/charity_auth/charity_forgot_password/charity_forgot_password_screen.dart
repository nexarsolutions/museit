...
import 'controller/charity_forgot_password_controller.dart';


class CharityForgotPasswordScreen extends StatelessWidget {
  CharityForgotPasswordScreen({super.key});

  final controller = Get.put(CharityForgotPasswordController());
