...
import 'package:musit/pages/charity_side/charity_home/add_songs/widget/add_songs_widget.dart';
            ...
            () => controller.selectedIndex.value == 0
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          Padding(
                            ...
                            child: AddSongsWidget(model: controller.spotifyList[index]),
                          ),
                    ),
                )
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    Padding(
                      padding: const EdgeInsets.only(left: 16.0,right: 16,bottom: 12),
                      child: AddSongsWidget(model: controller.youtubeList[index]),
                    ),
              ),
            )
                : Expanded(
