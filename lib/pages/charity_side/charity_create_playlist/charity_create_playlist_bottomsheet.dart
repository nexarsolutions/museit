...
import '../charity_home/add_songs/add_songs_screen.dart';

charityCreatePlaylistBottomSheet(){
  final controller = Get.put(CharityCreatePlaylistController());
  final formKey = GlobalKey<FormState>();

  return customBottomSheet(child: Form(
    key: formKey,
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Center(child: Text('Create Playlist',style: manRopeSemiBold.copyWith(fontSize: 14),)),
        const SizedBox(height: 24),
        Text('Playlist Title',style: manRopeSemiBold.copyWith(fontSize: 12),),
        SizedBox(height: 8,),
        CustomTextField(controller: controller.playlistTitleController, hintText: 'Add Text'),
        SizedBox(height: 16,),
